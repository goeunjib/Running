...
const movingImg = (evt) => {
  ...
  $(".box2-left").css({ left: -200 - x / 60, top: 0 - y / 30 });
  $(".box2-right").css({ right: -50 + x / 30, bottom: -50 + y / 60 });

  $(".box3-left").css({ left: -200 - x / 60, top: 0 - y / 30 });
  $(".box3-right").css({ right: -50 + x / 30, bottom: -50 + y / 60 });

  $(".box4-left").css({ left: -200 - x / 60, top: 0 - y / 30 });
  $(".box4-right").css({ right: -50 + x / 30, bottom: -50 + y / 60 });
...
$(".global-nav li").on("click", function () {
  ...
  $("html, body").stop().animate({ scrollTop: currentBox }, 500);
});
...
$(".box").each(function () {
  ...
  $(this).on("wheel", function (evt) {
    ...
    const prevBox = this.prevElementSibling;
